...
function renderResult(result, searchTerms, titleTag) {
  ...
  if (result.image) {
    ...
    wrapper.className = 'search-hero-result-image';
  ...
  if (result.title) {
    ...
    title.className = 'search-hero-result-title';
...
function clearSearchResults(block) {
  const searchResults = block.querySelector('.search-hero-results');
...
function searchResultsContainer(block) {
  ...
  results.className = 'search-hero-results';
...
function searchBox(block, config) {
  ...
  box.classList.add('search-hero-box');
  box.append(
    searchIcon(),
